// main.typ — Forlorn Oath: document assembly (cover, TOC, chapters).
#import "theme.typ": *

#set document(
  title: "Forlorn Oath — Monster Hunter Wilds Modlist & Guide",
  author: "Forlorn Oath",
)
...
#page(footer: none)[
  ...
  #v(1.6cm)
    ...
    #text(size: 60pt, weight: "bold", fill: scarlet)[◆]
    #v(1.2cm)
  ]
  #text(size: 40pt, weight: "bold", fill: banner)[Forlorn Oath]
  #v(0.45cm)
  #rect(width: 46%, height: 1.2pt, fill: gold)
  #v(0.55cm)
  #text(size: 13pt, fill: ink)[Monster Hunter Wilds]
  #v(0.2cm)
  #text(size: 11pt, fill: muted)[PC (Steam) · Game version 1.042.00.01 (August 2026)]
  #v(0.2cm)
  #text(size: 10.5pt, fill: muted)[18 mods · Fluffy Mod Manager + REFramework · Six Personas]
  #v(2.6cm)
