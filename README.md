...
This repo is a markdown planning workspace for the Elder Wilds modlist. The numbered planning files (`modlist-01.md` through `modlist-16.md`) each own one category of mod research and decision-making. The hub file `modlist.md` contains project scope, toolchain setup, and installation guidance.
