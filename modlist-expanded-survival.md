...
**MO2 Separator:** `05 Expanded Systems` → `05c Survival & Needs`

Part of the [`Expanded Systems`](modlist-06.md) section. See also: `06a` (Character & Progression), `06b` (Magic & Perks), `06d` (Crafting & Economy), `06e` (Followers & Reputation).

## Survival Systems → `05c`
...
## Roleplay Upkeep And Hygiene → `05c`
