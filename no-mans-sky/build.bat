@echo off
echo ============================================
echo  Aetherial Purity - PDF Generator (No Man's Sky)
echo ============================================
echo.
...
typst compile template.typ output/Aetherial-Purity.pdf
if %ERRORLEVEL% equ 0 (
    echo.
    echo ============================================
    echo  SUCCESS: PDF generated at output/Aetherial-Purity.pdf
    echo ============================================
) else (
    echo.
