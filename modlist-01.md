...
- `Actor Value Generator` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/84743> (SKSE modder's resource for creating custom actor values; hard requirement of `Classic Attributes` and other mods that add new stats/traits. 2,932 endorsements, 269k downloads, by NoahBoddie) → `01b`
