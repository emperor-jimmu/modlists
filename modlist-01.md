...
- Decide which bug-fix plugins are mandatory baseline vs optional, and confirm where `Unofficial Skyrim Special Edition Patch - USSEP` ownership lives relative to `modlist-15.md`
...
- `Unofficial Skyrim Special Edition Patch - USSEP` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/266> (foundational record patch; confirm ownership boundary with `modlist-15.md`)
