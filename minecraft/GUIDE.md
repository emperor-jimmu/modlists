...
| [Puzzles Lib](https://www.curseforge.com/minecraft/mc-mods/puzzles-lib)            | Config + utility library (Fuzss) — required by five pack mods                             | Leave My Bars Alone, Mindful Darkness, Hang Glider (Wave 2), Diagonal Fences (Wave 6), Stylish Effects |
