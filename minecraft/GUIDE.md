...
5. Fresh Animations: Extensions — **must stay above Fresh Animations**
6. Fresh Animations
7. Enhanced Boss Bars
8. Faithful 32x AppleSkin Addon (AppleSkin HUD icons — 32x Faithful style)
9. RAY's 3D Rails (3D rails + ladders)
10. Better Lanterns
...
| Wave 0.5 — Resource Packs       | 5       | 0      | 5       | EMF + ETF + Continuity + Sinytra Connector + Cull Leaves — client-side support mods for Armored Legacy (EMF/ETF), Overlay's (Continuity/Connector), Better Leaves perf (Cull Leaves); +11 resource packs −Patrix +Faithful (Aug 2026 resource pack review)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
