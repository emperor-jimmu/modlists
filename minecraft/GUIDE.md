...
| [Fancy Toasts](https://modrinth.com/mod/fancy-toasts) 1.5.0                                 | Animated advancement popups — 8 texture styles, 4 animations, per-type sounds; replaced Advancement Plaques (Aug 2026 swap; Fancy Notify 1.0.0 reverted — startup crash)       …                                                                                                                   |
...
- **Better Advancements** — overhauled advancements UI, open with `L`. Pairs with Fancy Toasts.
- **Fancy Toasts** — animated advancement popups: 8 texture styles (Vanilla-Like, OG, Nature, Modern, Terracraft, Steamy, Landspaper, Neon) × 4 animations (Standard, Playful, Quirky, Old-Like) with per-type sounds; two config screens via the Mods screen. Zero deps — replaced Advancement Plaques (Aug 2026 swap). **Fancy Notify 1.0.0 reverted** — crashed at startup (MusicManager NPE with The Immersive Music Mod; watch list). Iceberg stays for Item Borders.
