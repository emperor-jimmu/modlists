...
| [Tyz's Skills - Dark theme](https://www.curseforge.com/minecraft/texture-packs/tyzs-skills-dark-theme) v6.4                          | Dark 16x GUI theme for Tyz's Skills' skills menu — official companion (same author), matches the pack's dark-UI direction |
...
- **Tyz's Skills - Dark theme** — official companion resource pack (tyzbrand, same author as the mod): dark 16x GUI theme for the Tyz's Skills skills menu. v6.4 supports the pinned Tyz's Skills 6.4.2 (only compatible with 6.4+). Client-side, zero deps, All Rights Reserved (like Dark Coffee GUI), 1.8K CurseForge DL. Touches only the skills-mod screens — any position above the Faithful 32x base works.
...
24. Tyz's Skills Dark Theme (skills GUI — only touches Tyz's Skills screens; above the base pack)
...
| Mod                                                                               | Role                                                                                                             |
|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------|
| [Tyz's Skills](https://www.curseforge.com/minecraft/mc-mods/tyzs-skills)          | Passive leveling + skill points — gain XP from doing (mining, fighting, farming, crafting…), spend SP on permanent passive buffs |
...
**Tyz's Skills** — stock defaults (plug-and-play by design). No overrides authored blind — config generates at first launch (`config/tyzs_skills/`, 99% JSON-data-driven if tuning is ever wanted). [VERIFY] death penalties default OFF (chill rule); refund rate (30%) + XP sources acceptable.
...
- **Tyz's Skills** is zero-dependency (Modrinth API verified) and fully KubeJS-compatible — KubeJS (Wave 1) is already in the pack for recipe scripting, so skill events and data can be scripted without any new framework.
...
### Tyz's Skills — Passive Skill Growth

The pack's character layer — XP accrues passively from ordinary play and converts into permanent power stacked on top of the gear chase.

- **Level Up** — gain XP from basic actions: mining, fighting, breeding, eating, fishing, crafting, sleeping, discovering biomes, unlocking advancements. No XP bookkeeping to manage.
- **Skills** — each level-up grants Skill Points (bonuses every 5 levels); spend them on passive buffs (speed, damage, resistance, XP boosts…). Shift-click bulk-buys levels.
- **Level requirements + skill conflicts** — mid/high-tier skills unlock as you level; incompatible skills can be marked exclusive (JSON-configurable). The gear lanes stay open — this only shapes the passive layer.
- **Refunds** — 30% of the price back (configurable). Try builds without fear.
- **Zero dependencies** (MIT, Modrinth API verified) and **fully KubeJS-compatible** — Wave 1 KubeJS is already in the pack, so the tree can be extended or gated via `config/tyzs_skills/` JSON + scripts without new frameworks.
- **No duplication** — Relics levels gear through use; Tyz's Skills levels the *character*. They layer; they don't overlap.
- **Chill-safe** — XP gains are passive, buffs are small, no mob scaling; death penalties are configurable and kept OFF (default). [VERIFY] at first launch.

Open the skills menu with **`I`** (or the button in the inventory screen). The official **Dark Theme** resource pack restyles the GUI to match the pack's dark UI (see Texture Packs).
...
| **Session 6 — Passive skill tree** | Open the skills menu (`I`) and buy mining/combat/farming skills as SP comes in                               | Character progression alongside the gear chase |
...
| Wave 3 — Equipment Magic   | 8       | 8      | 17      | Simply Swords, Simply More, Too Many Bows, Arsenal (RPG Series), Relics, Immersive Armors, Easy Magic + 8 deps (Placebo, Patchouli, Simply Tooltips, Fzzy Config, Ranged Weapon API, Spell Engine, Shield API, Curios API) — −Project MMO −PMMO × Farmer's Delight Compat (Aug 27 2026 — reverted; not what the user wanted) −Skills Mastery Reimagined −Pufferfish's Skills −Pufferfish's Attributes (Aug 27 2026 — skills dropped; no tech-vibe tree, user decision) −Apotheosis −Apothic Compats −3 Apothic modules +Easy Magic (Aug 26 2026 removal), pins SS 1.63.0 + SM 1.2.3 +Tyz's Skills (Aug 31 2026 — skills restored; zero-dep, MIT, KubeJS-compatible)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Open Skills Menu      | `I`                   | Tyz's Skills            | 3    |
