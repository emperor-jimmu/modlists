...
| Mod                                                                                                               | Role                                                                                                                 |
|-------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
| [Project MMO](https://www.curseforge.com/minecraft/mc-mods/project-mmo)                                           | Skills & stats earned by doing — mining, crafting, smelting, combat — with tangible perks                            |
| [PMMO × Farmer's Delight Compat](https://www.curseforge.com/minecraft/mc-mods/project-mmo-farmers-delight-compat) | Farmer's Delight cooking blocks (Stove, Cooking Pot, Skillet, Cutting Board) grant PMMO XP for the foods they create |
...
**Project MMO** — the **Default Project MMO Pack** applies automatically to existing worlds; stock defaults everywhere else. **Mob-scaling check at first launch**: if mobs scale with player level, apply a tracked datapack override (`datapacks/`) to keep the flat-to-voluntary difficulty curve. Vein mining + skill fortune stay stock.
...
### Project MMO — Skills & Stats

Project MMO is the pack's XP engine: every action earns skill XP, and every level-up pays out a tangible perk. No item locks, no grinding meta — you level by simply playing the pack.

**What earns XP**: mining, woodcutting, farming, cooking, smelting, crafting, combat, swimming, sprinting — anything you actually do. Skills group into warfare, athletics, harvesting, artisanry, arcana, and social.

**Perks that matter here**:

- **Vein mining** — mining skill lets you pop connected ore veins in one swing: more ore per minute feeding Create crushers, Mekanism factories, and AE2 storage.
- **Skill fortune** — skill-based extra drops on top of vanilla fortune.
- **Movement & combat** — run speed, jump height, and attack damage scale with their skills.
- **Salvaging** — the smithing table breaks junk gear back into components.

**Glossary** (`P`): hover any item, or look at any block or mob, and press `P` to see exactly what XP it gives and what it requires. Press `P` on air to inspect your own character. This is the built-in wiki for the whole system.

**Chill stance**: XP is earned by playing, never lost, and nothing needs babysitting — ignore the system and it quietly levels you in the background.

**Mob-scaling watch**: PMMO can scale mob stats with player level. This pack keeps its difficulty curve flat-to-voluntary — mob scaling is verified at first launch and tamed via a tracked datapack override (`datapacks/`) if it's active. Vein mining and skill fortune stay stock.

**Farmer's Delight Compat**: FD cooking blocks (Stove, Cooking Pot, Skillet, Cutting Board) emit PMMO XP for the *finished* foods they create — your kitchen feeds your skills. Requires both mods (in pack). XP values live in PMMO's config, not the compat mod.
...
| Wave 3 — Equipment Magic   | 9       | 8      | 18      | Project MMO, PMMO × Farmer's Delight Compat, Simply Swords, Simply More, Too Many Bows, Arsenal (RPG Series), Relics, Immersive Armors, Easy Magic + 8 deps (Placebo, Patchouli, Simply Tooltips, Fzzy Config, Ranged Weapon API, Spell Engine, Shield API, Curios API) — +Project MMO +PMMO × Farmer's Delight Compat (Aug 27 2026 — skills re-added as Project MMO, reward-first; replaces the removed tree) −Skills Mastery Reimagined −Pufferfish's Skills −Pufferfish's Attributes (Aug 27 2026 — skills dropped; no tech-vibe tree, user decision) −Apotheosis −Apothic Compats −3 Apothic modules +Easy Magic (Aug 26 2026 removal), pins SS 1.63.0 + SM 1.2.3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| Wave 6 — Building          | 12      | 3      | 15      | Rechiseled, Supplementaries, Macaw's (4), Building Wands, Handcrafted, Fetzi's Displays, Lili's Pottery, Laser Bridges & Doors, Diagonal Fences + Create Deco + Rechiseled: Create, Rechiseled: AE2 + Moonlight, Resourceful, Fusion                                                                                                                                                                                                                                                                                                                                                                                                                                                                                …
...
| Open PMMO Glossary    | `P`                   | Project MMO             | 3    |
