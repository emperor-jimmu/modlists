...
- **Overflowing Bars** — health/armor/toughness bars expand past vanilla limits — useful for high-HP builds from Relics bonuses and enchanted gear. Requires **AttributeFix** (next bullet) for values beyond vanilla caps — without it the bar renders numbers the game silently clamps.
...
| [Arsenal (RPG Series)](https://modrinth.com/mod/arsenal-rpg-series)             | 40+ loot-only legendary weapons with passive spells — same RPG Series family as Relics                |
...
- **Ranged Weapon API** is shared between Relics (RPG Series) and Arsenal (RPG Series) — install once, used by all.
...
- **Improvable Skills** requires **HammerLib** (Zeith's library mod — same author, zero deps of its own; new dependency, auto-installs via XMCL from the Improvable Skills page, pinned 21.0.14 for 1.21.1). The optional JEI integration is skipped — the pack is EMI-only.
...
### Arsenal (RPG Series) — Loot-Only Legendary Weapons
...
**Finding them**: Boss drops + endgame dungeon chests (Twilight Forest, Cataclysm, YUNG's high-tier). EMI shows drop sources.
...
Enchanting stays vanilla-capped (Protection IV, Sharpness V). The gear fantasy now comes from unique weapon/armor passives (Simply Swords, Arsenal, Relics, Immersive Armors) rather than max-level enchantment stacking.
...
| Session                          | Focus                                                                                                       | What to Do                    |
|----------------------------------|-------------------------------------------------------------------------------------------------------------|-------------------------------|
| **Session 1 — First unique loot** | Check every gear drop and dungeon chest. Look for Simply Swords / Arsenal / Relics uniques               | Learn the loot system         |
| **Session 2 — Weapon hunt**      | Explorer's Compass → YUNG's dungeon → loot for a Simply Swords or Arsenal weapon. Try Rapier (fast) or Greathammer (AoE) | First unique weapon           |
...
| **Session 4 — Relic hunting**    | Monkey Talisman (dungeons) + Lucky Coin (mineshafts)                                                        | Accessory slots filled        |
