...
- [ ] **Pending**: no GUIDE.md / Mod Count / PDF changes (review only — no adoptions). Await user go-ahead on the two recommended adopts before documenting + queueing instance actions.
