...
- [ ] **Create: Café — TENTATIVE (user call pending)** — Create-native coffee/tea/boba (roasting/grinding/brewing via Create machines); only dep Create (in pack); 1.4.3 (Jan 2026); chill-living + Create-automation fit (Slice & Dice precedent). Counter: prior precedent skipped drink addons overlapping the drink hub (Kaleidoscope Tavern/Liquor/Wine, Create: Gears and Tavern) — but those were alcohol-themed vs Brewin' And Chewin's fermentation niche; Café's coffee/tea is the one drink category B&C does not cover. [VERIFY] at test launch: drink effect strength (overpowered check), Create version compat, no runtime conflict with B&C.
...
- [x] GUIDE.md updated: Performance & Rendering table + Sodium Extras note, Wave 4 table + Smarter Farmers section, Wave 6 table + Diagonal Fences section, Mod Count Summary (Wave 0 14→15 mods / 10→11 deps / 24→26; Wave 4 11→12; Wave 6 10→11 / 13→14; Total 169→172 mods, 46→47 deps, 215→219).
- [x] DRIFTWOOD-GUIDE.pdf regenerated.