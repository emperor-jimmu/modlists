...
| Lionfish API (required by Cataclysm) | 3.0     | `lionfishapi-3.0.jar`                      | [Download](https://cdn.modrinth.com/data/FoVacERa/versions/CPftDBcY/lionfishapi-3.0.jar)                      |
...
| Obscure API (required by Aquamirae)             | 18      | `obscure_api-18.jar`                           | [Download](https://cdn.modrinth.com/data/fU7jbFHc/versions/7sZmDObM/obscure_api-18.jar)                     |
...
| TCT Core (required by MAtmos)                                | 2.1     | `TCTcore-1.20.1.jar`                            | [Download](https://cdn.modrinth.com/data/MlsBPB9a/versions/TaGr5JhL/TCTcore-1.20.1.jar)                           |
| TerraBlender (required by Deep Aether)                        | 3.0.1.10 | `TerraBlender-forge-1.20.1-3.0.1.10.jar`        | [Download](https://cdn.modrinth.com/data/kkmrDlKT/versions/zGconCHG/TerraBlender-forge-1.20.1-3.0.1.10.jar)        |
...
| Deep Aether                   | 1.1.7    | `deep_aether-1.20.1-1.1.7.jar`                   | [Download](https://cdn.modrinth.com/data/gcHIih5B/versions/IE1ZMRN3/deep_aether-1.20.1-1.1.7.jar)                   |
...
>
> **Loot Journal: Pickup Notifier** requires **Fragmentum** (listed in Dependency Layer) — a lightweight framework mod from the Obscuria Collection. **Aquamirae** requires **Obscure API** (listed in Dependency Layer) — a shared library from the same collection providing animation, gameplay systems, and entity attributes.
>
...
>
> **Aquamirae** requires **Obscure API** (listed in Dependency Layer) — a shared library from the Obscuria Collection for animation, gameplay systems, and entity attributes.
>
...
> **Deep Aether** is an addon for **The Aether** — it adds 5 new biomes, Skyjade tools/armor, new mobs, and dungeon loot to the Aether dimension. Requires **TerraBlender** (listed in Dependency Layer) for biome generation. Install after The Aether (batch 12).
...
> **Reactive Music** is client-side only — dynamic music system that plays fantasy/Celtic tracks based on context. No additional dependencies. **MAtmos** adds biome-specific environmental ambient sounds (wind, water, forests, caves). Requires **TCT Core** (listed in Dependency Layer).
...
| Shaderpack | Version | Description | File | Direct Download |
|------------|---------|-------------|------|-----------------|
