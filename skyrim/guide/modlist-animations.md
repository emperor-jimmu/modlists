...
|--------------------------------------|------------------|---------------------------------|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **DAR** (Dynamic Animation Replacer) | Maintenance-only | —                               | No (closed) | Author inactive. Works on AE 1.6.1170 but no new features expected — if a future Skyrim update breaks DAR, nobody can fix it.                                                              |
...
| Mod                                                                                                                            | Type        | Notes                                                                                     |
|--------------------------------------------------------------------------------------------------------------------------------|-------------|-------------------------------------------------------------------------------------------|
| [SkyParkour v3 - Procedural Parkour and Climbing Framework (SPPF)](https://www.nexusmods.com/skyrimspecialedition/mods/132292) | Baseline    | Vault, climb, traverse environmental geometry.                                            |
...
| Mod | Type | Notes |
| --- | --- | --- |
| [Thundertrot Horse Animations](https://www.nexusmods.com/skyrimspecialedition/mods/140941) | Baseline | **Locked.** OAR-based horse movement/idle replacer (walk, trot, gallop). |
...
| Mod | Type | Notes |
| --- | --- | --- |
| [Riding Animation Overhaul - RAO (OAR)](https://www.nexusmods.com/skyrimspecialedition/mods/102881) | Alternative | Superseded by HAO (same author, mxnedula) with directional movement support. Fallback if HAO is abandoned. |
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|--------------------------------------------------------------------|
| **Heavy armor**                                                                                                                                             |             |                                                                    |
| [Leviathan Animations II - Male Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/81463)                                               | Baseline    | CATA Addon. Male heavy-armor locomotion.                            |
| [Leviathan Animations II - Female Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/80760)                                             | Baseline    | CATA Addon. Female heavy-armor locomotion.                          |
| **Light armor**                                                                                                                                             |             |                                                                    |
| [Vanargand Animations II - Male Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/99999)                                               | Baseline    | CATA Addon. Male light-armor locomotion.                            |
| [Vanargand Animations II - Female Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/100000)                                            | Baseline    | CATA Addon. Female light-armor locomotion.                          |
| **Mage (non-armored)**                                                                                                                                      |             |                                                                    |
| [Goetia Animations - Female Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/68005)                                                   | Baseline    | CATA Addon. Female mage locomotion.                                 |
| [Goetia Animations - Male Idle Walk And Run](https://www.nexusmods.com/skyrimspecialedition/mods/68625)                                                     | Baseline    | CATA Addon. Male mage locomotion.                                   |
...
| [Dynamic Female Swimming Idles](https://www.nexusmods.com/skyrimspecialedition/mods/128040)                                                             | Alternative | Swimming idle replacements. Complements Random Swimming Animations. |
| [Dynamic Female Rail Leaning](https://www.nexusmods.com/skyrimspecialedition/mods/93520)                                                              | Alternative | Rail-leaning idles at NPC idle markers. Player use needs Dovahkiin Can Lean (32748). |
| [Dynamic Female Ledge Sitting](https://www.nexusmods.com/skyrimspecialedition/mods/90252)                                                            | Alternative | Ledge-sitting idles at NPC idle markers. Player use needs Dovahkiin Can Lean (32748). |
| [Dynamic Female Hand Warming](https://www.nexusmods.com/skyrimspecialedition/mods/88506)                                                            | Alternative | Cold-weather hand-warming idles. Complements survival/weather stack. |
| [Seamless Varied Masculine Idles (OAR)](https://www.nexusmods.com/skyrimspecialedition/mods/96504)                                                   | Alternative | Male non-combat idle variety via OAR. |
| [Seamless Varied Feminine Idles (OAR)](https://www.nexusmods.com/skyrimspecialedition/mods/92226)                                                    | Alternative | Female non-combat idle variety via OAR. |
| [SD's Seamless Sneak Transition and Idles (OAR)](https://www.nexusmods.com/skyrimspecialedition/mods/133022)                                        | Alternative | Sneak idles and stand-to-sneak transitions. Complements Vanargand Sneak locomotion. |
...
| [Simple Diving System](https://www.nexusmods.com/skyrimspecialedition/mods/154534)                                                                         | Alternative     | OAR-based diving detection and animations for water entry from various heights. Requires Behavior Data Injector or Pandora. |
...
| [For Honor in Skyrim](https://www.nexusmods.com/skyrimspecialedition/mods/151478)                                                                                     | Prerequisite    | Asset base only. Required by For Honor Reforged for animation files. Do not run standalone — overwrite with 172176.                        |
| [For Honor Reforged](https://www.nexusmods.com/skyrimspecialedition/mods/172176)                                                                                     | Alternative     | Full For Honor combat moveset rebuilt with BFCO support, NPC AI (OAR), parry/guard-break/knockdown mechanics. Requires 151478 as asset base + DMK, Chocolate Poise, BFCO. |
...
| [Dynamic Dodge Animation](https://www.nexusmods.com/skyrimspecialedition/mods/79598)                                                                                     | Alternative     | SKSE-based dodge animation with i-frames. Potential TK Dodge RE companion.                 |
...
| [Improved Barstool Exit Animation](https://www.nexusmods.com/skyrimspecialedition/mods/143012)                                        | Alternative | OAR-based barstool exit animation fix. Requires SKDR (→ `Foundations`). |
...
| [Improved Idle Laydown Animations](https://www.nexusmods.com/skyrimspecialedition/mods/99691)                                         | Alternative | Ground/sleep laydown idle improvements.                            |
| [Improved Table Sit Transition Animations](https://www.nexusmods.com/skyrimspecialedition/mods/84160)                                | Alternative | Prevents plate/drink knockover when sitting at tables.             |
...
| [Conditional Armor Type Animations](https://www.nexusmods.com/skyrimspecialedition/mods/51507)           | Baseline    | Armor-type-based animation switching. Pairs with Leviathan II (heavy), Vanargand II (light), and Goetia (mage) CATA Addons in → `Locomotion`. |
...
| [Malignis Animations - Conditions](https://www.nexusmods.com/skyrimspecialedition/mods/132028)           | Alternative | OAR condition pack for animation variety. |
...
| [Ready to Play IED](https://www.nexusmods.com/skyrimspecialedition/mods/158531)                                      | Alternative | Pre-configured IED preset — fallback if manual IED configuration proves too time-consuming. |
...
| [Guards Pose With Weapons — IED-OAR](https://www.nexusmods.com/skyrimspecialedition/mods/110005)                  | Addon       | Guard and faction guards hold-weapon poses via IED + OAR. Requires both baselines. |
