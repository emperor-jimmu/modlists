...
| Mod                                                                                        | Description                                                                                                                                                                                             |
|--------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Azurite III CS](https://www.nexusmods.com/skyrimspecialedition/mods/162153)               | **Baseline.** Requires the balanced CS add-on tier or higher (SSGI, Screen Space Shadows, Grass Lighting, Wetness Effects). FOMOD with darker nights and reduced bloom for tunable grim-dark aesthetic. |
...
| [Real Weathers Remastered](https://www.nexusmods.com/skyrimspecialedition/mods/168776)        | CS-native ground-up build. DALC, moon phase lighting, physical sky approximation. Nights reported as very dark — test before adopting. |
...
| [Azurite Weathers III - Enhanced](https://www.nexusmods.com/skyrimspecialedition/mods/150269) | Later tuning layer.                                                                                                                    |
| [Skydreamus CS Presets](https://www.nexusmods.com/skyrimspecialedition/mods/171145)           | Later tuning layer.                                                                                                                    |
...
| Mod                                                                                                    | Description                                                                                                                                                                                                                                                                                 |
|--------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Azurite III CS - Realistic Darker Nights](https://www.nexusmods.com/skyrimspecialedition/mods/183498) | Darker night preset for Azurite III CS. Requires testing — darker nights affect third-person readability and combat detection. Needs Azurite III CS as base.                                                                                                                                |
| [Morning Fogs SSE](https://www.nexusmods.com/skyrimspecialedition/mods/21436)                          | Rolling morning fogs over lakes/rivers (dawn windows, MCM-tunable). Adds new atmospheric fog only — compatible with everything except `Interior Floating Fog Remover`. **Verify fog density for third-person readability (same gate as Mists of Tamriel) and Azurite III CS fog overhead.** |
...
| [CS Water — A Water Made For CS in mind](https://www.nexusmods.com/skyrimspecialedition/mods/172959) | **Baseline (2026-08-22).** CS-optimized water overhaul, PBR textures where CS supports them (partial, not universal PBR). Chain-adopted via TMD Dirt Roads PBR Restart (174071). Supersedes Simplicity of Sea — both edit all water records; CS Water is authored to win conflicts. Verify SoS removal and water testing. Already mapped in Synthesis (`A Water Made For CS in mind.esp` → `C.Water`). |
...
| Mod                                                                                                      | Description                                                                                                                  |
|----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|
| [Simplicity of Sea](https://www.nexusmods.com/skyrimspecialedition/mods/56520)                           | **Superseded baseline (2026-08-22)** by CS Water — fallback if CS Water fails testing. Pairs with Water Effects CS. |
...
| Mod | Description |
|-----|-------------|
| [Praedy's Night Sky AIO](https://www.nexusmods.com/skyrimspecialedition/mods/47530)   | **Locked.** Complete night-sky overhaul: stars (9 options), nebula (16 options), galaxy (4 options), constellations, Masser + Secunda moons, auroras. FOMOD-tunable. Choose 2K. |                                                                     |
...
| Mod                                                                                    | Description                                                                    |
|----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| [Rally's Celestial Canvas](https://www.nexusmods.com/skyrimspecialedition/mods/110869) | Praedy's AIO offers granular FOMOD tuning (9 star options, 16 nebula options). |
| [AURORA S.E.](https://www.nexusmods.com/skyrimspecialedition/mods/6021)                | Redundant with Praedy's aurora coverage.                                       |
| Realistic Galaxy / Ultra Hi-Res Nightsky / Worlds Behind Glass                        | Single-texture replacers; Praedy's AIO provides coherent full-sky coverage.                 |                                                                     |
| Draco's fantasy auroras / Draco's moons                                               | Redundant with Praedy's aurora and moon coverage.                                           |                                                                     |
| [Texture Overhaul Stars and Galaxy of Nirn](https://www.nexusmods.com/skyrimspecialedition/mods/41260) |  Single-texture replacer; Praedy's AIO provides coherent full-sky coverage.                          |
| [Skyrim Textures Redone - Stars](https://www.nexusmods.com/skyrimspecialedition/mods/4931) |  Single-texture replacer; Praedy's AIO provides coherent full-sky coverage.                          |
