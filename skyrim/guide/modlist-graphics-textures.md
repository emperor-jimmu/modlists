...
- **Embers XD - PBR** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/186037)) — PBR material conversion of the locked Embers XD baseline (→ [Lighting](modlist-graphics-lighting.md), Fire & Effects). Requires Embers XD + CS + PGPatcher (all baseline). Install after Embers XD, before running PGPatcher. Verify fire/ember reads correctly under CS.
