...
- New content mods must integrate cleanly with the modlist's Static with Hard Threat progression dial (→ [Design Philosophy](modlist-design-philosophy.md)).
- Testing methodology and maintenance workflow is owned by → [Testing & Maintenance](modlist-performance-testing.md).
