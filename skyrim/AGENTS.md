...
- **Embers XD - PBR (186037):** PBR material conversion of the Embers XD baseline (2026-08-22). Requires Embers XD + CS + PGPatcher. `modlist-graphics-textures.md` → PBR Support.
