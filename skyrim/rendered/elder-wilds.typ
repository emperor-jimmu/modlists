...
#table(
  ...
  [Rejected — requires Campfire, which is rejected with Frostfall.],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/168776")[Nexus]],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/151229")[Nexus]],
...
#table(
  ...
  [Rejected],
  [Rejected — BFCO is the locked combat animation framework. Mutually exclusive with BFCO.],
  ...
  [Rejected],
  [Comprehensive combat overhaul. Competes with BFCO and Valhalla (both locked).],
...
#table(
  ...
  [Rejected],
  [MCO-specific. Requires MCO (rejected). Find BFCO-compatible troll animation alternative.],
)
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/117115")[MCO ADXP - Modern Movement Combat Overhaul]],
  [Rejected],
  [Rejected — BFCO is the locked combat animation framework.],
...
#table(
  ...
  [Rejected],
  [#1, #2, #3, #4],
  [Rejected — Skyrim Unbound Reborn is the locked alternate start.],
  ...
  [Baseline],
  [all],
  [*Locked.* Configurable start with full Dragonborn-quest control. Pairs with "Why I Came to Skyrim - Origin Stories."],
  ...
  [Rejected],
  [all],
  [Rejected — depends on Alternate Perspective which is rejected.],
...
#table(
  ...
  [Rejected],
  [#3],
  [Restrained fallback. Rejected — Aetherius is the locked Simonrim path.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/1315")[Imperious — Races of Skyrim]],
  [Rejected],
  [#1, #4],
  [High-expression comparison. Rejected — Aetherius is the locked Simonrim path.],
)
...
#table(
  ...
  [Rejected],
  [#1, #2, #4],
  [Simonrim alternative. Rejected — Evenstar is the locked path.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/14910")[Andromeda — Standing Stones]],
  [Rejected],
  [#1, #4],
  [High-expression comparison. Rejected — Evenstar is the locked path.],
)
...
#table(
  ...
  [Rejected],
  [#3],
  [Restrained fallback. Rejected — Pilgrim is the locked Simonrim path.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/22506")[Wintersun — Faiths of Skyrim]],
  [Rejected],
  [#1, #4],
  [High-expression route. Rejected — Pilgrim is the locked Simonrim path.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/45011")[Gods And Worship]],
  [Rejected],
  [#1, #2, #4],
  [Full deity worship system. Rejected — Pilgrim is the locked Simonrim path.],
)
...
#table(
  ...
  [Rejected],
  [#1, #2, #4],
  [Restrained alternative. Rejected in favor of Adamant (Simonrim coherence).],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/1137")[Ordinator — Perks of Skyrim]],
  [Rejected],
  [#1, #4],
  [High-complexity branch. Rejected — Simonrim stack (Adamant/Mysticism/Starfrost) is the locked path.],
)
...
#table(
  ...
  [Rejected],
  [#1, #4],
  [Moderate expansion. Rejected — Mysticism + Triumvirate is the locked path.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/1090")[Apocalypse — Magic of Skyrim]],
  [Rejected],
  [#1, #4],
  [Maximum spell variety. Rejected — Mysticism + Triumvirate is the locked path.],
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/158139")[Lost Grimoire - B.O.O.B.I.E.S Support]],
  [Addition],
  [#1, #2, #4],
  [Spell tome icons via B.O.O.B.I.E.S. Requires Lost Grimoire + B.O.O.B.I.E.S.],
...
#table(
  ...
  [Rejected],
  [#1, #2, #4],
  [Rejected — Starfrost is the locked Simonrim survival baseline.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/56393")[Last Seed — Survival Needs]],
  [Rejected],
  [#1, #2, #4],
  [Heavier classic route. Rejected — Starfrost is the locked Simonrim survival baseline.],
  ...
  [Rejected],
  [#1],
  [Harsh wilderness route. Rejected — script load and UI complexity risk 3P/GP pillar.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/37693")[Skills of the Wild] v2.0+],
  [Rejected],
  [#1],
  [4 new skill trees (Hunting, Foraging, Tracking, Camping). Requires Campfire — rejected.],
)
...
#table(
  ...
  [Baseline],
  [#1, #4],
  [Curated loot progression. SkyPatched variant — no ESP slot, runtime patching. Pairs with Arena encounter zones and the Static with Hard Threat dial.],
...
- *Campfire* (#link("https://www.nexusmods.com/skyrimspecialedition/mods/667")[Nexus]) — Rejected. Starfrost is the locked survival baseline.
...
#table(
  ...
  [Rejected — requires Campfire, which is rejected with the Frostfall ecosystem. Compatible with Campfire (667), Embers XD. Incompatible with other campfire-replacing mods.],
)
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/150999")[Nexus]],
...
#table(
  ...
  [Baseline],
  [Clean dragon presentation upgrade. Locked — safer compatibility with Dragon War and behavior mods.],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/132218")[Dragons SE]],
  [Rejected],
  [Full dragon model replacer. Rejected — Iconic's is the locked path. Not compatible.],
