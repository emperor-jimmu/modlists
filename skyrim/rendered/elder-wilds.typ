...
#table(
  ...
  [Water for ENB],
  [No],
  [No ENB; water stack is CS (CS Water — A Water Made For CS in mind + Water Effects CS). Also skipped when using Realistic Water Two.],
)
...
- *Embers XD - PBR* (#link("https://www.nexusmods.com/skyrimspecialedition/mods/186037")[Nexus]) — PBR material conversion of the locked Embers XD baseline (→ @graphics-lighting-lighting, Fire & Effects). Requires Embers XD + CS + PGPatcher (all baseline). Install after Embers XD, before running PGPatcher. Verify fire/ember reads correctly under CS.
...
#table(
  ...
  [*Superseded baseline (2026-08-22)* by CS Water — fallback if CS Water fails testing. Pairs with Water Effects CS.],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/145119")[TMD Dirt Roads]],
  [Region-varied dirt road meshes replacing vanilla stone roads. ESM-flagged. Coexists with Blended Roads (its roads still used where TMD doesn't edit).],
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/174071")[TMD Dirt Roads PBR Restart]],
  [PBR remake of the deprecated TMD Dirt Roads PBR — all-new textures, region-varied. Requires TMD Dirt Roads + CS + PGPatcher + CS Water (172959, → @graphics-weather-weather--water). Load before PBR landscape overhauls. *TomatoRim PBR Landscapes patch is "Coming soon" — blend with the locked TomatoRim baseline is unfinished (accepted 2026-08-22).*],
)
...
#table(
  ...
  [`iMaxPlayerLevel`],
  [500],
  [Much higher cap (250 → 500, 2026-08-20) for the power-fantasy ramp — quest mods, discovery, clearing, Skyshards keep feeding XP while the static world stops scaling, so the player outgrows nearly everyone by mid/late game. Tunable upward (e.g. 1000) for an even steeper fantasy.],
  [`fSkillCapBase`],
  [18],
  ...
  [Vanilla],
  [Default Skyrim leveling curve — deliberately kept so the early game levels at a normal pace; the ramp comes from content-fed XP and the high cap, not from a faster curve.],
  [`bUseRacialCaps`],
  [true (default)],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/138534")[The Ratway Passages]],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/40658")[Nordic Faces - Immersive Characters Overhaul]],
  [Baseline],
  [Plugin-less unified base layer — textures, meshes, FaceGen only (zero record edits, no black-face risk). Vanilla-faithful modern-texture overhaul for player + all NPCs incl. beastfolk. Loads under the regional/race-specific stack; BnP skins installed after still win. Re-run FacegenBaseline.],
...
#table(
  ...
  [#link("https://www.nexusmods.com/skyrimspecialedition/mods/135085")[Ashe — Crystal Heart]],
  [3000+],
  [DLC-sized fully-voiced Breton follower: personal quest (vengeance → introspection), new lands, slow-burn romance. No hard requirements; optional integrations map to baselines (OAR, FSMP, HPH, SkyPatcher, OStim, BFCO). *Tentative* — verify script overhead, tone (anime/Nier-influenced vs grim-dark), and NPC/worldspace edit conflicts; contact author (collection permission).],
  [Recruit in Winking Skeever (Solitude), 200 gold. Install near bottom of load order. Custom follower system — do not assign via NFF/AFT. Asherana banter patch (167123) pairs with SDA baseline.],
)
...
#table(
  ...
  [Ashe],
  [*No*],
  [Custom follower system — do not assign via NFF/AFT.],
)
