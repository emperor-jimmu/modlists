...
- **The Ratway Passages (138534)** — Tentative (adoptable). YeahButIronically, 325 endo, v1.1.1 (updated Aug 2026 — active). New dungeon connecting the Ratway to Honeyside, Riften Jail/sewers, Hall of the Dead, Beggar's Row, and outside the city walls. Fits "new content" + "big dark world" pillars; local traversal only — no conflict with the locked Journeyman fast-travel stack. Well-received on r/skyrimmods ("why wasn't this in the base game"). Verify gates: xEdit pass vs the Riften stack (The City of Crossed Daggers - Riften Expansion 168629, Caught Red Handed 65708 jail edits, Honeyside/player-home edits), self-contained sewer section (Skyrim Sewers not in list), ESL flag + navmesh, 1.6.1170 test launch. `modlist-world-content.md` → Dungeons And Ruins baseline (tentative row added).
