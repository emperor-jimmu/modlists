...
#callout("The core formula:", [*items per second* = (machine crafting speed) × (1 + speed bonus) ÷ (recipe time in seconds) × (1 + productivity bonus)])
