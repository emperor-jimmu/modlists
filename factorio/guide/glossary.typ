...
*Transport belt* — a one-way conveyor that carries items at a fixed speed (a yellow belt moves 15 items per second); underground belts dive under obstacles and splitters divide one belt into two.
...
*Science pack* — the research currency consumed by labs; red (automation) science is copper plates + iron gear wheels, green (logistic) science is a transport belt + an inserter, and later packs add oil and advanced chains.

*Research* — a technology unlocked by feeding science packs into labs; the research queue lets you line up several technologies so labs never idle.
