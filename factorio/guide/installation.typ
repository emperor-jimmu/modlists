...
- *Wave 0 — The Castaway*: the base game plus the eight-mod QoL base — Even Distribution, Squeak Through 2, Rate Calculator, Factory Planner, YARM, Todo List, Alien Biomes and Bottleneck Lite. This is the persistent core of all three waves.
- *Wave 1 — The Architect*: the Wave 0 base plus the eleven scaling mods — Miniloader (Redux), Deadlock's Stacking Beltboxes & Compact Loaders, Warehousing Mod, Project Cybersyn, Circuit HUD V2, Module Inserter, Auto Deconstruct, Nixie Tubes, Belt Visualizer, Prismatic Belts and Circuit Visualizer. Runs the base game (Space Age off).
