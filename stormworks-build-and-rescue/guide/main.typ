// main.typ — Whitecap: document assembly (cover, TOC, chapters).
#import "theme.typ": *

#set document(
  title: "Whitecap — Stormworks: Build and Rescue Modlist & Guide",
  author: "Whitecap",
)
...
#page(footer: none)[
  ...
  #v(0.9cm)
  #text(size: 38pt, weight: "bold", fill: amber)[Whitecap]
  #v(0.4cm)
  #rect(width: 46%, height: 1.2pt, fill: orange)
  #v(0.5cm)
  #text(size: 13pt, fill: ink)[Stormworks: Build and Rescue v1.15.18]
  #v(0.2cm)
  #text(size: 11pt, fill: muted)[Modlist · Installation · Field Manual · Personas]
  #v(2.4cm)
  #text(size: 9.5pt, fill: muted)[Compiled August 2026 — Stormworks v1.15.18 / Steam Workshop Mod Manager]
]
