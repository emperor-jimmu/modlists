...
**MO2 Separator:** `05 Expanded Systems` → `05e Followers & Reputation`

Part of the [`Expanded Systems`](modlist-06.md) section. See also: `06a` (Character & Progression), `06b` (Magic & Perks), `06c` (Survival & Needs), `06d` (Crafting & Economy).

## Crime, Reputation, And Social Systems → `05e`
...
## Followers And Companion Systems → `05e`
...
## Romance, Marriage, And Companionship → `05e`
