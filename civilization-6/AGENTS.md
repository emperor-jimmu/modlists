...
- **Two layers (user directive, 2026-08-11)**: the list ships as **Layer 1 "Vanilla+"** — UI/QoL + graphics mods only, zero gameplay change, for learning the vanilla game — and **Layer 2 "The Grand Chronicle"** — Layer 1 plus the AI overhaul, tech-tree mods, and content (resources, wonders, maps). The split is documented in `guide/20-modlist.typ`; personas assume Layer 2.
