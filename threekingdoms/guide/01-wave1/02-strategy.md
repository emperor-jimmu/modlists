...
1. Play as **Cao Cao** (best diplomatic tools) and focus on vassals + credibility.
2. Deliberately use spies to dismantle one enemy faction from the inside.
3. Build at least two specialized armies (e.g., one defensive, one aggressive cavalry).
