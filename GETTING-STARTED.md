...
| **Ars Nouveau**  | Craft the **Worn Notebook** — it's the complete in-game guide covering all spells, glyphs, and mechanics. **Ars Elemental** extends it with 4 elemental schools, new glyphs, and spell foci — learn alongside Ars Nouveau. Also: [Ars Nouveau Guide](https://www.minecraft-guides.com/mod/ars-nouveau/) and [Ars.Guide](https://ars.guide/). |
