...
Part of the [`Performance and Technical Workflow`](modlist-performance.md) section. See also: `Performance Strategy`, `Optimization & Configuration`, `Tool Pipeline`, `Bashed Patch & Synthesis`.
