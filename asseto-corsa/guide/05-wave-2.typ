...
- *Weather & dynamic conditions* — Sol/Pure weather scripts
...
1. Start a race on a dry track with Sol weather progression (time accelerated)
...
- *Conditions:* AI races (higher aggression), online practice, mixed weather (Sol)
...
#table(
  ...
  table.header([Phase], [Title], [Wave], [Focus]),
