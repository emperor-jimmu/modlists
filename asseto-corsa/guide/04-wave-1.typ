...
- *If the minimum speed is too low:* You are braking too deep, not trail-braking enough, or over-slowing
...
#figure(
  image("../assets/racing-line-reference.png", width: 50%),
  caption: [
...
#figure(
  image("../assets/ideal-racing-line.png", width: 50%),
  caption: [
