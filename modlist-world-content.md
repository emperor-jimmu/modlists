...
- **JK's Fort Dawnguard** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/110645)) — Fort Dawnguard interior overhaul with new clutter, lighting, and environmental storytelling. By JPSteel2, ESL-flagged. Complements the Dawnguard faction questline. → `World Content - Overhauls`
- **JK's Castle Volkihar** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/116314)) — Castle Volkihar interior overhaul. Adds clutter, architecture detail, and lived-in atmosphere to the vampire castle. By JPSteel2, ESL-flagged. → `World Content - Overhauls`
- **JK's Dark Brotherhood Sanctuaries** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/121950)) — Dark Brotherhood sanctuary interior overhauls (Falkreath, Dawnstar, Volunruud). New clutter and detail for each sanctuary. By JPSteel2, ESL-flagged. → `World Content - Overhauls`
...
- **Obscure's College ↔ CS-native lighting:** No official patch — OCW's FOMOD includes ELFX, Luminosity, and Relighting Skyrim patches but not CS Light, True Light, or WSU. OCW's CellSettings.esp light record forwarding will need verification in xEdit to ensure CS Light + True Light's exterior bulbs and interior templates apply correctly to OCW cells. The OCW Meshes Optimized and Merged for CS patch ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/139165)) merges OCW architecture meshes to reduce drawcalls for Light Limit Fix — install as part of OCW setup.
...
- **Lund's Hamlet - An Overhaul** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/169830)) — Niche farmstead option. Lund's Hut only, with built-in LotD patch and optional compatibility patches for Lanterns of Skyrim II, Embers XD, Nature of the Wild Lands. Best evaluated after a travel-stop and restoration baseline are in place. → `World Content - Overhauls`
...
- **Ivarstead Source** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/118825)) — Targeted landscape fix. Adds a visible river source to the Ivarstead river, fixing the magical water-flow anomaly. ESL-flagged, JK's Skyrim compatible. → `World Content - Overhauls`
- **Animated Ships** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/110260)) — Adds idle-bobbing and sail animations to ships and boats at docks. Visual-only, no scripts. → `World Content - Overhauls`
    - **Animated Ships - Finer Sails** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/112517)) — Higher-resolution sail textures for Animated Ships. Install after the base mod. → `World Content - Overhauls`
- **Dynamic Boats at Docks - Official Patch Hub** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/172901)) — Patch collection for Dynamic Boats at Docks covering city overhauls, new-lands mods, and landscape mods. Required if using settlement overhauls that touch dock cells. → `World Content - Overhauls`
- **Snowy Ships for Snowy Regions** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/111827)) — Visual add-on. Applies snow shaders to ships in snowy regions. Complements Animated Ships. BOS-based. → `World Content - Overhauls`
...
- **Skyrim's Got Talent - Player Reactions Addon** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/78629)) — NPC reactions expansion for SGT. Adds voiced audience reactions, applause, tips, and commentary during performances. Complements the base mod. → `World Content - Quests`
- **Skyrim's Got Talent - Show in UI** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/135473)) — Optional UI companion. Displays SGT song selection in a proper HUD widget instead of dialogue menus. Improves third-person gamepad flow for bard performances. → `World Content - Quests`
    - **Skyrim's Got Talent - Show in UI (Visual Improvements)** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/172079)) — Visual upgrade for the SGT UI widget. Install after the base UI mod; compatibility should be verified. → `World Content - Quests`
...
- **Brawling - No Hitting Bystanders** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/116941)) — Brawling fix. Prevents accidental hits to bystanders during brawls. Clean gameplay QoL for the "living the world" pillar. → `World Content - Quests`

### Alternatives

- **Simple Hunting Overhaul** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/95943)) — Simpler hunting alternative by jayserpa. Replaces one-click looting with skinning (skinned animal visuals, time passage, fade-to-black effect), carcass pickup (SHIFT + E via Dynamic Activation Key), voiced NPC trading, suspension of disbelief reactions, poaching/permits. Intentionally lighter than Hunterborn — no sub-menus, no separate harvesting system. If chosen, replaces Hunterborn as the hunting baseline. Requires `Dynamic Activation Key` ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/96273)). → `World Content - Quests`
    - **Main file:** `Simple Hunting Overhaul` (the base mod). One main file; optional Bruma patch available.
    - **Immersive Hunting Animations** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/96961)) — Companion animation pack. Adds dedicated hunting animations (skinning, carcass pickup, butchering). Requires OAR. Use only if SHO is the chosen baseline. → `World Content - Quests`
    - **Immersive Carcass Carrying** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/99867)) — Visual companion for SHO. Makes carrying carcasses on your back visible in third-person. Requires OAR, IED. → `World Content - Quests`
    - **Hunters Loot - and skin animals** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/119348)) — NPC-hunter companion. Makes hunting NPCs walk to and skin/loot the animals they kill. SPID-based, ESL-flagged, integrates with SHO. → `World Content - Quests`
...
- **Become a Bard** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/2303)) / **Bards Reborn Student of Song Become a Bard and Bards College Expansion** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/47994)) — Heavier bard-overhaul alternative to Skyrim's Got Talent. Adds full Bards College questline, instruments as equipable items, busking, and bard skill trees. Bards Reborn is the maintained successor integrating Become a Bard with Bards College expansion. Not compatible with SGT without a patch. → `World Content - Quests`
- **Skyrim's Got Talent - Bards Reborn Patch** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/51740)) — Compatibility patch between SGT and Bards Reborn. Required only if both are installed. → `World Content - Quests`
...
- **Missives - Notes Retexture Darkened** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/111765)) — Darker variant of the notes retexture. Choose one variant, not both. → `World Content - Quests`
- **Diverse Witcher Missives Boards - Base Object Swapper** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/111770)) — BOS-based missive board visual replacer with Witcher-inspired board designs. Cosmetic only, replaces board meshes. → `World Content - Quests`
- **Missives - Unique Missive Boards** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/111375)) — BOS-based missive board replacer giving each hold a unique board design. Stacks with `Missives - Notes Retexture`. → `World Content - Quests`
- **Missives - Quest Edits for Unique Missive Board Mods** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/112095)) — Patch companion for unique board mods. Required if using any BOS missive board replacer. → `World Content - Quests`
- **Missives Quest Conversion** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/135984)) — Quest-system variant for Missives. Converts selected missives into proper quest-journal entries with objectives. Adds quest variety without replacing the base system. → `World Content - Quests`
...
- **JaySerpa's Quest Expansions** (House of Horrors [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/57285) + Paarthurnax [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/51711) + The Only Cure [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/57683) + The Whispering Door [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/76606) + patches hub [Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/113083)) — Default vanilla-quest-enhancement layer. Modular, standalone. Start with the four flagship entries and expand from there. Meaningful decision branches and alternate paths without new worldspaces. The Whispering Door adds a good/evil ending for Mephala's quest with consequences linked to Skyrim Reputation and Aetherium Forge Destroys Items. → `World Content - Quests`
...
- **Rescue Missions** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/144251)) — Radiant rescue quest. Non-hostile NPCs can be captured by bandits and held in hand-picked dungeon locations. Rescue them for a reward and disposition boost; repeatable with configurable spawn chance via MCM. Uses vanilla voice lines, requires SkyUI. v1.0.5, ESL-flagged. Optional exterior-locations pack available as separate file. → `World Content - Quests`
- **Vessel of the Soul** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/174434)) — 300 unique slotless talismans hidden at fixed locations across Skyrim. Equip-limit system (1 slot at start, +1 every 10 levels), overload penalties for exceeding slots. Effects range from simple stat boosts to perk-like abilities. Found at world locations only (no crafting, no leveled lists). Pre-requisite: Description Framework ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/105799)) for item description text. → `World Content - Quests`
    - **Main file:** `Vessel of the Soul` (the base mod). Single main file.
- **Apocryphal Library** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/121654)) — BOS-based book discovery in Apocrypha. Converts static book stacks and paper piles into lootable containers with new books (156+ books, 40+ notes, skill books). Optional levelled-list distribution addon available. Requires `Base Object Swapper`. → `World Content - Quests`
    - **Main file:** `Apocryphal Library` (the base mod). One main file; optional Levelled List and Bibliophile's Arcanaeum patch files.
- **Book Covers Skyrim - Lost Library** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/902)) — Book content expansion. Adds 150+ lore books from earlier TES games to leveled lists and world containers. Complements Book Covers Skyrim (textures) by adding actual new readable content. From the same author as Book Covers Skyrim. → `World Content - Quests`
    - **Main file:** `Book Covers Skyrim - Lost Library` (the base mod). One main file; install after Book Covers Skyrim.
- **Descriptions for Lost Library and Apocryphal Library** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/169437)) — Description Framework addon. Adds descriptive text for books from Lost Library and Apocryphal Library. Requires Description Framework. → `World Content - Quests`
- **All Books and Notes Descriptions** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/107239)) — Description Framework addon. Adds descriptive text for 1000+ vanilla books and notes. Requires Description Framework. Alternative to Blurbs of Skyrim ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/107198)) — pick one variant. → `World Content - Quests`
- **Aetherium Forge Destroys Items (AFDI)** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/114021)) — Quest-adjacent mechanic. Dropping items (mundane, enchanted, Daedric artifacts, Black Books) into the Aetherium Forge lava destroys them permanently with visual effects, Daedric Prince responses, and minion spawns. Unlocks perk-point rewards for artifact destruction. Hard requirements: SKSE64, powerofthree's Papyrus Extender, KID. v2.0.12. → `World Content - Quests`
    - **Main file:** `Aetherium Forge Destroys Items` (base mod). 1K textures in main; optional 2K/4K texture packs available.
    - **Built-in compatibility:** Skyrim Reputation, Wintersun, The Whispering Door - Quest Expansion, Defy the Gardener. → `World Content - Quests`
- **Siege at Icemoth** ([Nexus](https://www.nexusmods.com/skyrimspecialedition/mods/109541)) — Small-scale vanilla-esque new-lands quest mod. Adds the Hjorkvild Isles in the Sea of Ghosts with dungeons, a necromancer boss, unique items from TES Blades, a custom voiced shout (spliced), and guard dialogue by Paul Ganus. Fully navmeshed, follower-friendly. v1.5, ESL-flagged. → `World Content - Quests`
    - **Main file:** `Siege at Icemoth` (the base mod). One main file; optional survival-mode integration patch.
