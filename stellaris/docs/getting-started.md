...
Origins are your empire's **starting situation and backstory**. Some start on a different planet type, some begin with advanced technology, some face unique challenges. Origins are **locked at game start** — you cannot change them.
...
Traits are your species' biological characteristics. You have a **point budget** — positive traits cost points, negative traits refund them.

**Efficient beginner picks:**

- **Intelligent** (+10% research speed) — research is king
- **Rapid Breeders** (+10% pop growth) — pops are everything
- **Adaptive** (+10% habitability) — more colonizable planets
...
Civics are your empire's **governmental policies** and specializations. You choose two at game start (some origins grant a third).
...
Stellaris has **9 basic resources** organized into three tiers:
...
Planets are the **engine of your entire economy**. Every resource comes from a planet.

### Districts vs Buildings

- **Districts** — large slots that provide basic jobs (generator/mining/agriculture). City districts provide housing and unlock building slots.
- **Buildings** — smaller slots that provide advanced jobs (researchers, administrators, alloy workers). Unlocked by city districts and technology.

### Jobs & Pops

Each district and building creates **jobs**. Your **pops** (population units) fill these jobs. An employed pop produces resources. An unemployed pop is unhappy and can migrate.

**The pop pipeline:** Pop grows → Pop needs a job → Job produces → Resources fuel empire

### Planet Specialization

Once you have 5+ pops on a planet, you can set its **designation**. This gives a production bonus to that planet's primary job type.

- **Generator World** — energy production +25%
- **Mining World** — mineral production +25%
- **Forge World** — alloy production +25%
- **Factory World** — consumer goods +25%
- **Tech World** — research +15%
- **Urban World** — trade value +20%, housing +15%
- **Rural World** — all basic resource jobs +10%

**Tip:** Don't mix and match on one planet. Specialize each planet for one resource type.

## The First 30 Years — What You Actually Do

### Year 1–5: Exploration Phase

1. **Pause immediately.** Look at your homeworld. Queue up a mix of districts and buildings.
2. **Build your first science ship** (if you didn't start with two). Set both to "Survey" in different directions.
3. **Build a construction ship.** Start building starbases in adjacent systems to claim territory.
4. **Build 2-3 more science ships** as your economy allows. Exploration is the most important early activity.

### Year 5–20: Expansion Phase

1. Identify **chokepoints** — systems where your territory naturally narrows. Build starbases there.
2. Start your **first colony** — look for a planet with high habitability (green = 80%, yellow = 60%).
3. Keep surveying. **Anomalies** are the best source of early game rewards.
4. **Meet neighbors.** Send an envoy to improve relations with anyone who isn't immediately hostile.

### Year 20–30: Consolidation Phase

1. Your first colony should be self-sufficient by now. Start a **second colony**.
2. Build your **first military fleet** — 20-30 corvettes is enough to deter early aggression.
3. Research **society techs** that unlock more starbases and colonies.
4. Pick a **tradition tree** — Discovery (science) or Expansion (territory) are strong early picks.

## Understanding War

War in Stellaris is **not like other strategy games**. Here's what you need to know:

- **You need a Casus Belli (CB)** to declare war. Claims on enemy systems (costs influence) give you a CB.
- **War Exhaustion** builds over time as you fight. At 100%, you are forced into a status quo peace.
- **Taking systems** requires occupying the planet in that system with armies.
- **Armies** are built separately from fleets. They land on planets to conquer them.
- The **ship designer** lets you customize ships. Auto-design is fine for beginners.
- **Fleet capacity** limits how many ships you can have before paying extra upkeep. Starbases with anchorages increase it.
- **Naval capacity** = 10 + anchorage slots + technology. A fleet of 20 corvettes is ~40 naval capacity.

## Victory — What Are You Playing For?
...
These are critical things Stellaris never explains:

1. **Pause is your best friend.** Pause every time you get a notification, a popup, or need to think. There's no penalty for pausing.
2. **Survey everything.** Every system in explored space. Anomalies and dig sites are your primary source of early rewards.
3. **Don't neglect your fleet.** Even as a pacifist, you need a fleet. AI empires consider fleet power when deciding whether to attack.
4. **Factions matter.** Keep your largest faction happy (+20% resource output) — check the Factions tab and adopt policies that please them.
5. **Sprawl is a soft cap, not a hard one.** Going over your administrative capacity gives a tech/unity penalty — but expanding is usually worth it anyway.
6. **Trade value is collected by starbases.** Your trade route network matters. Piracy spawns on unpatched trade routes.
7. **Sectors are automatic.** When you have too many planets, they auto-assign to sectors. You can set sector focus (economy, military, etc.).
8. **First contact takes time.** When you encounter a new alien empire, it takes months to establish communications. You can speed this up with envoys.
9. **Relics and archaeology.** Dig sites appear on surveyed planets. They tell stories and give powerful rewards. Always do them.
10. **The crisis is real.** Around 2400, one of three end-game crises will spawn. You need a fleet of 200K+ power (or more) to face it. Prepare.

## DLC Features You Should Know About
...
Once you understand these fundamentals, proceed to [Modlist Setup](modlist-setup.md) to prepare your modded environment.
