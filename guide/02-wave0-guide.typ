...
RDR2 alternates between story missions and open-world free roam. A typical
session looks like:

1. Wake up at camp — check the ledger for upgrades, donate to maintain
   provisions
2. Check Arthur's satchel — craft or eat if cores are low
3. Pick a story mission (yellow icons on the map), a side mission (white
   icons), or head into the wilderness to hunt and explore
4. Return to camp or a town to sell loot, rest, save
5. Maintain cores (health, stamina, dead eye) by eating, sleeping, and
   using tonics
...
better accuracy stats and higher end-of-mission payouts.
