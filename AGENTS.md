...
- `minecraft/`, `skyrim/`, `cyberpunk/`, `ets2/`, `rimworld/`, `gtaiv/`, `gtav/`, `rdr2/`, `arma3/`, `starfield/`, `starbound/`, `x4-foundations/`, `asseto-corsa/`, `automobilista-2/`, `baldurs-gate-3/`, `shogun2/`, `threekingdoms/`, `fs25/`, `f1-25/`, `masseffect/`, `mb2-bannerlord/`, `warhammer-3/`, `witcher-3/`, `ck3/`, `kerbal-space-program/`, `project-zomboid/`, `stardew-valley/`, `stellaris/`, and `terraria/` were imported via `git subtree` — their full history is preserved in this repo
