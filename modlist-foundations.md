...
**MO2 Separator:** `Foundations` → `Foundations - SKSE & Scripts`, `Foundations - Core Libraries`, `Foundations - Mesh & Texture Fixes`, `Foundations - Targeted Bugfixes`

## Foundations Baseline → `Foundations - Core Libraries`
...
- `SKSE64` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/30379> → `Foundations - SKSE & Scripts`
- `Address Library for SKSE Plugins` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/32444> → `Foundations - Core Libraries`
- `Unofficial Skyrim Special Edition Patch - USSEP` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/266> (foundational record patch. Requires the four free Creation Club masters (`ccbgssse001-fish.esm`, `ccqdrsse001-survivalmode.esl`, `ccbgssse037-curios.esl`, `ccbgssse025-advdsgs.esm`) and `_ResourcePack.esl` that ship with the 1.6.1170 runtime — no paid AE Upgrade needed.) → `Foundations - Core Libraries`
- `SSE Engine Fixes` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/17230> → `Foundations - Core Libraries`
- `SSE Display Tweaks` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/34705> (mandatory baseline for display behavior, frame pacing, and frame-cap control) → `Foundations - Core Libraries`
- `Scrambled Bugs` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/43532> → `Foundations - Core Libraries`
- `powerofthree's Tweaks` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/51073> → `Foundations - Core Libraries`
- `powerofthree's Papyrus Extender` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/22854> → `Foundations - Core Libraries`
- `PapyrusUtil` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/13048> → `Foundations - Core Libraries`
- `JContainers` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/16495> → `Foundations - Core Libraries`
- `Keyword Item Distributor (KID)` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/55728> → `Foundations - Core Libraries`
- `Spell Perk Item Distributor (SPID)` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/36869> → `Foundations - Core Libraries`
- `Base Object Swapper (BOS)` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/60805> → `Foundations - Core Libraries`
- `Crash Logger SSE AE VR` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/59818> → `Foundations - Core Libraries`
- `SkyPatcher` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/106659> → `Foundations - Core Libraries`
- `Dual Casting Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/92454> → `Foundations - Core Libraries`
- `Andrealphus' Papyrus Functions` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/85252> → `Foundations - Core Libraries`
- `ConsoleUtilSSE NG` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/76649> → `Foundations - Core Libraries`
- `Kris's Papyrus Extender` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/115164> → `Foundations - Core Libraries`
- `Animation Queue Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/82395> → `Foundations - Core Libraries`
- `Papyrus Tweaks NG` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/77779> → `Foundations - Core Libraries`
- `Lexicon SKSE` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/153176> → `Foundations - Core Libraries`
- `Actor Value Generator` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/84743> → `Foundations - Core Libraries`
- `XEMI Utility` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/159084> → `Foundations - Core Libraries`
- `Particle Patch` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/65720> → `Foundations - Mesh & Texture Fixes`
- `Assorted Mesh Fixes` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/32117> → `Foundations - Mesh & Texture Fixes`
- `Flickering Meshes Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/53957> → `Foundations - Mesh & Texture Fixes`
...
## Candidate Baseline To Research → `Foundations - Core Libraries`

- `SKSE64` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/30379> → `Foundations - SKSE & Scripts`
- `Address Library for SKSE Plugins` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/32444> → `Foundations - Core Libraries`
- `Unofficial Skyrim Special Edition Patch - USSEP` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/266> (foundational record patch owned by section `Foundations`. Requires the four free Creation Club masters (`ccbgssse001-fish.esm`, `ccqdrsse001-survivalmode.esl`, `ccbgssse037-curios.esl`, `ccbgssse025-advdsgs.esm`) and `_ResourcePack.esl` that ship with the 1.6.1170 runtime — no paid AE Upgrade needed.) → `Foundations - Core Libraries`
- `SSE Engine Fixes` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/17230> → `Foundations - Core Libraries`
- `SSE Display Tweaks` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/34705> (mandatory baseline for display behavior, frame pacing, and frame-cap control) → `Foundations - Core Libraries`
- `Scrambled Bugs` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/43532> → `Foundations - Core Libraries`
- `powerofthree's Tweaks` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/51073> → `Foundations - Core Libraries`
...
- `Base Object Swapper (BOS)` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/60805> → `Foundations - Core Libraries`
- `Crash Logger SSE AE VR` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/59818> → `Foundations - Core Libraries`
- `SkyPatcher` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/106659> (SKSE-plugin engine tweak framework; hard requirement of section 09 wildlife/AI mods and broadly useful as a vanilla-record patcher layer) → `Foundations - Core Libraries`
- `Dual Casting Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/92454> (powerofthree SKSE-plugin bugfix; hard requirement of `Blade and Blunt` from section 11) → `Foundations - Core Libraries`
- `Andrealphus' Papyrus Functions` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/85252> (SKSE-plugin Papyrus utility; hard requirement of `Dragon War` from section 09) → `Foundations - Core Libraries`
- `ConsoleUtilSSE NG` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/76649> (SKSE-plugin console utility; shared hard requirement of `Dragon War` from section 09 and several animation behaviour mods from section 03) → `Foundations - Core Libraries`
- `Kris's Papyrus Extender` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/115164> (SKSE-plugin Papyrus utility; hard requirement of `Bathing in Skyrim - Renewed` from section 05) → `Foundations - Core Libraries`
- `Animation Queue Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/82395> (animation-stack stability fix for heavy `Open Animation Replacer` / behavior loads; strongest current answer to the section's animation-engine placeholder) → `Foundations - Core Libraries`
- `Papyrus Tweaks NG` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/77779> (SKSE-plugin script-engine performance fixes and tweaks; configurable Papyrus operations-per-frame limit, native-call speedup, and stack-dump timeout. 22k endorsements, updated Oct 2025. Widely adopted by Step, Lexy's, and modern modding guides as a baseline script-performance layer.) → `Foundations - Core Libraries`
- `Lexicon SKSE` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/153176> (SKSE scripting engine for creating custom scripted functions, types, and events; hard requirement of newer `Actor Value Generator` versions. 1,462 endorsements, by NoahBoddie) → `Foundations - Core Libraries`
- `Actor Value Generator` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/84743> (SKSE modder's resource for creating custom actor values; hard requirement of `Classic Attributes` and other mods that add new stats/traits. Requires `Lexicon SKSE`. 2,932 endorsements, 269k downloads, by NoahBoddie) → `Foundations - Core Libraries`
- `XEMI Utility` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/159084> (SKSE-plugin utility for setting up custom collision primitives on activators and furniture; prerequisite for `FYX - Nordic Doors and Traps Collisions` from section 02. 22 endorsements, by powerofthree) → `Foundations - Core Libraries`
- `Particle Patch` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/65720> (particle shader/LOD corrections; originally ENB-focused but compatible with `Community Shaders` and vanilla game. 26k endorsements, updated Mar 2026) → `Foundations - Mesh & Texture Fixes`
- `Assorted Mesh Fixes` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/32117> (mesh correction collection for common visual errors; lightweight, no dependencies) → `Foundations - Mesh & Texture Fixes`
- `Flickering Meshes Fix` - Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/53957> (resolves distant-object mesh flicker in landscape transitions) → `Foundations - Mesh & Texture Fixes`
...
- This subsection adopts the canonical `xEdit` patching workflow (the `Method` developed by `Elminster` and documented by `elwaps`) as the patching philosophy for `Elder Wilds`: install one mod at a time, run `xEdit` in `Very Quick Show Conflicts` mode, resolve the conflicts the new mod causes, and use `ModGroups` to hide the intentional ones. → `Foundations - Core Libraries`
...
- Megapatch route: one large manually-built compatibility plugin that absorbs every conflict resolution, and individual mods are never inspected in `xEdit` until something breaks. → `Foundations - Core Libraries`
- Mod-by-mod route: install one mod at a time, run `xEdit` in `Very Quick Show Conflicts` mode, resolve only the conflicts that new mod introduces, and use small focused `ModGroups` to hide the intentional ones from future inspections. → `Foundations - Core Libraries`
- Automated route: rely on `Bashed Patch` and `Synthesis` patchers to merge records automatically, with little to no manual record-level review. → `Foundations - Core Libraries`

### Recommendation

- Use the mod-by-mod route as the default for every source mod, and reserve `Bashed Patch` plus `Synthesis` for the categories where they genuinely help. → `Foundations - Core Libraries`
...
- `Bashed Patch` and `Synthesis` are scoped, not general-purpose. Use them only for the categories each tool genuinely owns; never as a junk drawer for decisions that should remain explicit per-mod patches. → `Foundations - Core Libraries`
...
- One mega `ModGroup` containing every conflicting pair is a maintenance trap. Disabling or updating one source mod invalidates the whole group, and the next `-veryquickshowconflicts` run produces a wall of red again. Per-pair `ModGroups` are the whole point. → `Foundations - Core Libraries`
...
- Manually flipping `ESL` to `ESP` (or vice versa) can push the load order past its limit, change the merge order, and silently break the resolved tree. Only do it when the mod author or `xEdit` itself explicitly says to. → `Foundations - Core Libraries`
- `QAC` is not a cure-all. A mod that is dirty at the `ITM`/`UDR` level can still be broken at the record level, and a `QAC`-cleaned mod that still misbehaves needs manual `xEdit` review, not a second round of `QAC`. → `Foundations - Core Libraries`
...
- `*.ModGroup` files left in the `MO2 overwrite` folder survive across `xEdit` runs and become invisible garbage. Always move them into their owning source mod's folder inside `MO2` immediately after `xEdit` closes. → `Foundations - Core Libraries`
- Tiny per-pair patches that override one or two records tend to multiply. A list that ends up with fifty small `xx.esp` files is hard to reason about. Consider promoting them into themed region or feature patches when the count starts to look unmanageable, but keep the merge decision explicit rather than letting a `Bashed Patch` absorb it silently. → `Foundations - Core Libraries`
- `-veryquickshowconflicts` is the workflow, not `-quickautoclean` or `-showconflicts`. Using the slower mode once the list is large produces the wall-of-red problem the method is designed to avoid. → `Foundations - Core Libraries`
- Heavy `Synthesis` patcher chains can produce a single file that takes longer to rebuild than the underlying mod list took to assemble, and they tend to hide which patcher contributed which record. Keep patcher counts modest and name the output by date. → `Foundations - Core Libraries`
...
- Every `*.ModGroup` file lives inside the `MO2` folder of the source mod whose conflicts it hides, never in the `overwrite` folder. → `Foundations - Core Libraries`
...
- Patches are rebuilt after every source-mod update that touches a record the patch owns, and stale patches are caught by `SSEEdit` review rather than by in-game symptoms. → `Foundations - Core Libraries`
- The list survives a deliberate test in which one upstream source mod is disabled: its `ModGroup` and dependent patches should cleanly stop being useful instead of producing new conflicts. → `Foundations - Core Libraries`

## ESP To ESL Conversion → `Foundations - Core Libraries`
...
- **Form count:** A plugin can only be flagged `ESL` if it contains fewer than `2048` new record forms (not including forms inherited from its masters). `SSEEdit` shows the form count in the header. If the form count exceeds `2048`, the plugin cannot be ESL-flagged without compacting its form IDs first (a more involved process documented below). → `Foundations - Core Libraries`
- **No new cell or worldspace records:** Plugins that add new `CELL`, `WRLD`, `NAVM`, or `NAVI` records generally cannot be ESL-flagged without breaking references. `SSEEdit` will show these record types in the file's tree. → `Foundations - Core Libraries`
- **No dialogue or quest alias changes:** Some `QUST` and `DIAL` records have hard-coded form ID expectations and break when re-indexed. Check for quest and dialogue overrides before converting. → `Foundations - Core Libraries`
- **Known exceptions:** Certain mod types (header-meshes, body-slide outputs, SKSE plugins, texture replacers with dummy ESPs) are trivially convertible because they have zero or near-zero new records — these are safe to flag `ESL` immediately. → `Foundations - Core Libraries`
...
- **Never convert plugins that add `CELL`, `WRLD`, `NAVM`, or `NAVI` records unless you have verified every cross-reference manually.** These record types use their form ID as their persistent worldspace identifier, and compacting them orphans any mod or save that references the original location. → `Foundations - Core Libraries`
...
- **Never convert a plugin that another mod lists as a master** without checking whether the dependent mod hard-codes any of the to-be-compacted form IDs. If `Mod B` (ESP) lists `Mod A` (to be ESL) as a master, converting `Mod A` can break `Mod B`'s references. → `Foundations - Core Libraries`
- **`ESL`-flagged plugins still count in the `4096` light-plugin limit.** `4096` is a large but finite cap, and some engine operations (faction membership, equipped items, placed references) degrade when too many light plugins contribute records to the same scene. Do not flag every small ESP just because you can. → `Foundations - Core Libraries`
- **`xEdit` will warn you** when compacting would break something, but the warning only catches direct form-ID mismatches within the loaded plugin set, not indirect breaks through Papyrus scripts or through unloaded plugins. Read the warning carefully and abort if it reports potential issues. → `Foundations - Core Libraries`
...
- SKSE plugin dummy ESPs (`SKSE\Plugins` mods that ship a stub ESP for load-order sorting). → `Foundations - Core Libraries`
- Single-weapon, single-armor, or single-spell mods with no scripts, no quests, and fewer than `50` new records. → `Foundations - Core Libraries`
- Crafting recipe-only ESPs (recipes reference existing items, they do not create new world records).
- Patches you create yourself during the mod-by-mod patching workflow (always use `[Template] ESL` when creating the patch file). → `Foundations - Core Libraries`

### Plugins To Never Convert

- Major quest mods (`Legacy of the Dragonborn`, `Interesting NPCs`, `Vigilant`) that add thousands of records across quests, dialogues, worldspaces, and scripts. These almost always exceed the form-count limit or have cell/worldspace edits. → `Foundations - Core Libraries`
- City and settlement overhauls that add new `CELL` or `WRLD` records. → `Foundations - Core Libraries`
- Overhauls that add new dialogue branches or follower frameworks with quest aliases.
- Any plugin that `LOOT` or `SSEEdit` explicitly flags as not ESL-safe. → `Foundations - Core Libraries`
...
NOT INSTALLED - `I'm Walkin' Here NG with Pets` (Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/122516>) — ally/pet body-blocking → `Foundations - Targeted Bugfixes`
...
**NOTE -> Other bard mods make this unnecessary** - `Bard Instrumentals Mostly - Sing Rarely` (Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/10927>) — repetitive tavern singing (last updated 2017; still functional as a simple condition edit) → `Audio - SFX & Ambience`
...
- `Explosion Collision Fix` (Nexus: <https://www.nexusmods.com/skyrimspecialedition/mods/154076>) — prevents explosion-force spells from launching large objects into the player's camera, fixing a longstanding destructible-physics annoyance → `Foundations - Targeted Bugfixes`

### Candidate TODO Additions → `Foundations - Targeted Bugfixes`
