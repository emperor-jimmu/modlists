...
1. Complete a full long-haul leg: payload/fuel briefing, FMC program, oceanic routing, night cruise, and a CAT II/III-appropriate arrival.
2. Manage the fuel day: plan trip + reserve + alternate, and fly a diversion from the plan.
3. Run an oceanic crossing with the long-haul routing tools and position reporting the track demands.
4. Fly a low-visibility arrival using the aircraft's automation to minimums.
5. Graduate: the ace's certificate is one perfect long-haul night — cargo on time, fuel to spare, and the calm of someone who planned for everything.

===== Mission Ideas

+ *The red-eye freight* — a night crossing with a payload deadline: the classic 777F mission.
+ *The ocean diversion* — an engine or systems scenario mid-ocean: the diversion plan was made on the ground; now it gets flown.
+ *The minimums arrival* — a foggy destination at the edge of the aircraft's approach capability: brief, fly, and decide like a captain.
