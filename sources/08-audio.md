...
Enhances ETS2 audio: engine sounds, ambient/environment audio, UI sounds, horn packs, and comprehensive sound fixes.
...
- Engine and horn sounds for AI traffic vehicles (including Scania Citywide, buses, tractors)
- Wet tire sounds during rain for trailers in AI traffic
- Cleaner game log (fewer nameless variant warnings than vanilla)
- Improved mixing for standalone air horns in Service Shops
- Music track probability balancing in AI traffic vehicles
- Compatible with all maps, trucks, and an unlimited number of truck sound mods

**Compatibility:** ETS2 1.59+ (requires update for 1.60), all map DLCs, works with Promods and all maps. Must have high priority in Mod Manager (above rain sound mods, AI traffic mods, and map mods). Supported in Convoy mode.

**Performance Impact:** Negligible (<1% FPS loss) — only replaces audio banks, no visual processing.

---

## SFX Engine Sound Packs (Kreichbaum-style)

High-quality studio-recorded engine sound replacements for specific trucks, by creator "Max2712" (SFX series).
...
- DC16 V8 480-580hp (4 Series)
- DC16 V8 500-730hp (5-6 Series)
- DC16 V8 520/580/730hp (6 Series Euro 6 & Euro 5 EEV)
- DC16 V8 520-770hp (NG Scania)
- DSC14 V8 460-530hp (4 Series)
- Opticruise shifting and retarder sounds
- Gearbox whine, engine fan, interior insulation effects
- Sound attenuation for realistic fade-off at a distance

**Compatibility:** ETS2 1.59 (likely compatible with 1.60 with testing)
...
Kriechbaum is one of the most well-known ETS2 sound mod creators, producing high-fidelity engine recordings. His mods are typically per-engine/per-truck. Below are the packs available on ets2mods.lt:
...
**Compatibility:** Listed for 1.47 — may require updates for 1.60
...
**Compatibility:** Listed for 1.49 — may require updates for 1.60
...
**Compatibility:** Listed for 1.46 — requires updates for 1.60
...
```
HIGH PRIORITY
  Sound Fixes Pack (above rain sound mods, AI traffic mods, map mods)
  |
  v
  Truck engine sound packs (no conflict with Sound Fixes Pack)
  |
  v
LOW PRIORITY (below map mods)
```
