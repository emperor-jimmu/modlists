...
- Review any chosen quest route later against `modlist-16.md` so `Legacy of the Dragonborn` integration value and patch pressure are considered on purpose.
...
- It must stay disciplined enough that display-heavy housing does not quietly duplicate the role already reserved for `Legacy of the Dragonborn` in `modlist-16.md`.
...
- Keep display-heavy mansions separate from the museum or safehouse question reserved for `modlist-16.md`.
