...
| 2026-08-03 | Authentic Hydroponics (id 3714900958) REJECTED - redundant | Both it and Better Hydroponics add early Cactus/Cotton hydroponics; Better Hydroponics is far more adopted (27,531 vs 127 subs) and older (created 2023-04 vs created 2026-04-26). Running both risks conflicts. Single hydroponics overhaul included. Logged in mod-ideas.md. |
| 2026-08-03 | Handturrets (id 3694936216) REJECTED - power spike at game start | Its own description adds a "New start (Big Iron...)" that hands the player a turret at game start - power handed out without research/material cost, violating the wave's no-free-power rule. Logged in mod-ideas.md. |
| 2026-08-03 | Portable Crossbow Turret (id 778082429) REJECTED - distinct older mod, game-start handoff | A SEPARATE mod from the accepted "Portable Crossbow Turret kit" (id 2563788360). This 2016 mod adds a game start with crossbow knowledge (hand-off risk) and has no updates since 2016. Logged in mod-ideas.md. |
| 2026-08-03 | Crafting Expanded (id 1642114061) REJECTED - author-abandoned | Its own description: "I will no longer support or update this modification, since Kenshi II is now being worked on." Last updated 2019-11-11; includes drug-production recipes (cocaine, opium) that diverge from the crafting theme. Logged in mod-ideas.md. |
| 2026-08-03 | Siege Equipment (id 886085735) REJECTED - superseded | 2017 mod; author confirms in comments it was "made before crossbows were added"; superseded by Vanilla Crossbow Turrets + Portable Crossbow Turret kit. Logged in mod-ideas.md. |
