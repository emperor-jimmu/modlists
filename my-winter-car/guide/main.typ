// main.typ — Routa: document assembly (cover, TOC, chapters).
#import "theme.typ": *
...
#show heading: it => block(
  ...
  below: if it.level == 1 { 1.6em } else { 1.1em },
...
#page(footer: none)[
  ...
  #v(0.5cm)
  #text(size: 13pt, fill: ink)[My Winter Car v.260516-01]
  #v(0.2cm)
  #text(size: 11pt, fill: muted)[Alivieska, January 1999 — the ground is frozen solid]
  #v(0.2cm)
  #text(size: 11pt, fill: ink)[Modlist · Installation · Field Manual · Personas]
  #v(2.4cm)
  #text(size: 9.5pt, fill: muted)[Compiled August 2026 — My Winter Car v.260516-01 / MSCLoader v1.4.2]
]
