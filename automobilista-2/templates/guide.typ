...
#cmarker.render(read("../guide/00-install.md"), raw-typst: true)
#pagebreak()
...
#cmarker.render(read("../guide/01-wave-0-rookie.md"), raw-typst: true)
#pagebreak()
...
#cmarker.render(read("../guide/02-wave-1-national.md"), raw-typst: true)
#pagebreak()
...
#cmarker.render(read("../guide/03-wave-2-international.md"), raw-typst: true)
#pagebreak()
...
#cmarker.render(read("../guide/04-wave-3-championship.md"), raw-typst: true)
#pagebreak()
#cmarker.render(read("../guide/appendix-mod-reference.md"), raw-typst: true)
#pagebreak()
#cmarker.render(read("../guide/appendix-glossary.md"), raw-typst: true)
