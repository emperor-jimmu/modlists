...
+ *Baseline lap* — Run 5 laps to warm tyres. Save the fastest clean lap
+ *Export* — Use AMS2's built-in telemetry export or a third-party tool like Second Monitor
+ *Compare* — Overlay your best lap against a lap that was 9/10 effort. Where do the traces diverge?
+ *Identify* — Find the single corner where you lose the most time. One corner at a time
+ *Focus session* — Drive 10 laps targeting only that corner. Ignore the rest of the lap
+ *Re-test* — Export again and confirm improvement. If no change, adjust your approach and repeat
...
*Next:* #link("04-wave-3-championship.md")[Wave 3 — World Championship]
