...
#show raw.where(block: true): set text(font: ("JetBrains Mono", "Consolas", "Courier New"), size: 0.9em)
#show raw.where(block: true): set block(fill: luma(248), radius: 3pt, inset: 8pt)
#show raw.where(block: false): set text(font: ("JetBrains Mono", "Consolas", "Courier New"), size: 0.9em)
...
#let note(body) = block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: rgb("#3B82F6"))[Note]
    #v(4pt)
    #body
  ],
)
#let tip(body) = block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: rgb("#10B981"))[Tip]
    #v(4pt)
    #body
  ],
)
#let warning(body) = block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: rgb("#F59E0B"))[Warning]
    #v(4pt)
    #body
  ],
)
#let caution(body) = block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: rgb("#EF4444"))[Caution]
    #v(4pt)
    #body
  ],
)
#let important(body) = block(
  ...
  width: 100%,
  [
    #text(weight: "bold", fill: rgb("#8B5CF6"))[Important]
    #v(4pt)
    #body
  ],
)
...
#show line: set line(stroke: 1pt + rgb("#CBD5E1"))
#show quote: block.with(
  fill: luma(248),
  stroke: (left: 3pt + rgb("#CBD5E1")),
  inset: (left: 10pt, right: 6pt, top: 4pt, bottom: 4pt),
  radius: 2pt,
)
...
#table(
  columns: 5,
  fill: (x, y) => if y == 0 { rgb("#E2E8F0") } else if calc.rem(y - 1, 2) == 0 { luma(242) } else { none },
