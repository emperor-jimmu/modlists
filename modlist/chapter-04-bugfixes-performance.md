...
- Optimize game performance for smooth 4K gameplay
- Understand what impacts TPS (ticks per second)

## Overview
<!-- TODO: Explain that RimWorld's engine has quirks. These mods fix issues without changing gameplay. Performance mods keep the game running smoothly with 100+ mods. -->
...
## Next Steps
Proceed to [Chapter 5: UI / HUD](chapter-05-ui-hud.md).
